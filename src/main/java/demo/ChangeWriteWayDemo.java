...
public class ChangeWriteWayDemo {
    ...
    static class VideoHandle implements Runnable{
        ...
        VideoHandle(double frameIndex, String srcFile, String desDir, double fps, Size frameSize) {
            ...
            this.videoWriter =  new VideoWriter(desDir+"\\"+FILE_NAME_PRE+"-"+outNum.incrementAndGet()+"-"+videoCapture.get(0)+ ".avi",
    ...
    static {
        // 加载dll文件
        System.load("..//lib//opencv_java400.dll");
    }

    public static void main(String[] args) throws Exception {
        new ChangeWriteWayDemo().handleVideo("D:\\Encode_1080P_4.mp4","D:");
        log.info("视频解析完毕");
    }
